<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Pensez à utiliser un mot de passe sûr, différent de celui de votre compte EPITECH.
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Nouveau mot de passe (confirmation)" />
