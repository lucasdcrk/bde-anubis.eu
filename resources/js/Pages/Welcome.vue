<template>
    <div class="relative flex items-top justify-center min-h-screen bg-black sm:items-center sm:pt-0">
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div>
                <img src="https://i.imgur.com/3XyvBTu.jpg" alt="">
            </div>
            <div class="flex justify-center my-5">
                <a v-if="!$page.props.user" :href="route('login')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="215" height="41" viewBox="0 0 215 41"><title>
                        MS-SymbolLockup</title>
                ...
                <inertia-link v-else :href="route('dashboard')" class="text-xl text-yellow-400">
                    Accèder à la plateforme &rarr;
                </inertia-link>
            </div>
        </div>
    </div>
